...
import com.laser.library.camera.listener.CaptureListener;
...
import com.laser.library.camera.listener.TypeListener;
import com.laser.library.camera.state.CameraMachine;
import com.laser.library.camera.util.FileUtil;
import com.laser.library.camera.util.LogUtil;
import com.laser.library.camera.util.ScreenUtils;
import com.laser.library.camera.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    public static final int REQUEST_CODE_THUMB = 0x104;
    ...
    private View viewSwitchCamera;
    private View viewFlashLamp;

    private NewCaptureLayout mCaptureLayout;
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.camera_full_view, this);
        mVideoView = (VideoView) view.findViewById(R.id.video_preview);
        viewPreview =  view.findViewById(R.id.view_preview);
        viewImage =  view.findViewById(R.id.view_image);
        mPhoto = (ImageView) view.findViewById(R.id.image_photo);
        mSwitchCamera = (ImageView) view.findViewById(R.id.image_switch);
        viewSwitchCamera = view.findViewById(R.id.view_image_switch);
//        mSwitchCamera.setImageResource(iconSrc);
        mFlashLamp = (ImageView) view.findViewById(R.id.image_flash);
        viewFlashLamp = view.findViewById(R.id.view_image_flash);
        setFlashRes();
        viewFlashLamp.setOnClickListener(new OnClickListener() {
            @Override
...
//            }
//        });
        mCaptureLayout = (NewCaptureLayout) view.findViewById(R.id.capture_layout);
        mCaptureLayout.setDuration(duration);
        mCaptureLayout.setIconSrc(iconLeft, iconRight);
        mFoucsView = (FoucsView) view.findViewById(R.id.fouce_view);
        mVideoView.getHolder().addCallback(this);
        //切换摄像头
        viewSwitchCamera.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                    rightClickListener.onClick();
        ...
        viewThumb = findViewById(R.id.thumb_view);
        viewThumb.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_PICK, null);
                intent.setDataAndType(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, "image/*");
                ((Activity)mContext).startActivityForResult(intent, REQUEST_CODE_THUMB);
            }
        });
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (screenProp == 0) {
            Log.d("CameraParamUtil","measure videoview width:"+widthSize+" height:"+heightSize);
...
//        }
        ...
        Log.d("CameraParamUtil","captureBitmap width:"+ captureBitmap.getWidth()+"  height:"+captureBitmap.getHeight());
    ...
    public void setPreviewSize(int previewSize) {
        CameraInterface.getInstance().setPreviewSize(previewSize);
    }

    @Override
    public void setPictureSize(int pictureSize) {
        CameraInterface.getInstance().setPictureSize(pictureSize);
    }
