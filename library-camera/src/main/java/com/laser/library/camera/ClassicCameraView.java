...
public class ClassicCameraView  extends FrameLayout implements CameraInterface.CameraOpenOverCallback, Callback, CameraView {
    ...
    public ClassicCameraView(@NonNull Context context) {
        this(context, null);
    }

    public ClassicCameraView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClassicCameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        });
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Thread() {
            @Override
            public void run() {
                CameraInterface.getInstance().doOpenCamera(ClassicCameraView.this);
            }
        }.start();
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void playVideo(Bitmap firstFrame, final String url) {
        videoUrl = url;
        ClassicCameraView.this.firstFrame = firstFrame;
