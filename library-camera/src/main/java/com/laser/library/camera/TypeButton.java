...
//            canvas.drawPath(path, mPaint);
            ...
            canvas.drawBitmap(CameraParamUtil.decodeBitmapFromVector(getContext(), R.drawable.ic_cancel),new Matrix(),mPaint);
...
//            path.close();
//            canvas.drawPath(path, mPaint);
            canvas.drawBitmap(CameraParamUtil.decodeBitmapFromVector(getContext(), R.drawable.ic_confirm),new Matrix(),mPaint);
        }
    }
}
