...
import com.laser.library.camera.listener.ReturnListener;
import com.laser.library.camera.listener.TypeListener;

public class NewCaptureLayout extends FrameLayout {
    ...
    private ImageView iv_thumb;        //返回按钮
//    private ReturnButton btn_return;        //返回按钮
    ...
    public NewCaptureLayout(Context context) {
        this(context, null);
    }

    public NewCaptureLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewCaptureLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                resetCaptureLayout();
        ...
        //返回按钮
        iv_thumb = new ImageView(getContext());
        LayoutParams iv_thumb_param = new LayoutParams((int) (button_size / 1.5f), (int) (button_size / 1.5f));
        iv_thumb_param.gravity = Gravity.CENTER_VERTICAL;
        iv_thumb_param.setMargins(layout_width / 8, 0, 0, 0);
        iv_thumb.setLayoutParams(iv_thumb_param);
        iv_thumb.setImageDrawable(getResources().getDrawable(R.drawable.ic_camera));
