...
import com.laser.library.camera.util.AngleUtil;
import com.laser.library.camera.util.CameraParamUtil;
import com.laser.library.camera.util.CheckPermission;
import com.laser.library.camera.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private int preview_size = 1000;
    private int picture_size = 1200;
    ...
    void setSwitchView(ImageView mSwitchView, ImageView mFlashLamp) {
...
//        mCamera = Camera.open();
     ...
     * doStartPreview
     */
    public Camera.Size doStartPreview(SurfaceHolder holder, float screenProp) {
...
//                        .getSupportedPreviewSizes(), preview_size, screenProp,true);
//                Camera.Size pictureSize = previewSize;
                Camera.Size pictureSize = CameraParamUtil.getInstance().getPictureSize(mParams
                        .getSupportedPictureSizes(), picture_size, screenProp,false);
